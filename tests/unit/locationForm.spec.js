...
describe('LocationForm.vue', () => {
  ...
  it('emits the correct event when location is saved', async () => {
    const wrapper = shallowMount(LocationForm, {
      stubs,
      propsData: {
        method: 'create',
  ...
  it('emits the correct event when location is deleted', async () => {
    const wrapper = shallowMount(LocationForm, {
      stubs,
      propsData: {
        method: 'modify',
  ...
  it('sends the correct arguments when deleting a location', async () => {
    const wrapper = shallowMount(LocationForm, {
      stubs,
      propsData: {
        id: 42,
  ...
  it('Correctly watches currentLocation updates', async () => {
    const wrapper = shallowMount(LocationForm, {
      stubs,
      propsData: {
        method: 'modify',
  ...
  it('Correctly watches currentPhysical updates', async () => {
    const wrapper = shallowMount(LocationForm, {
      stubs,
      propsData: {
        method: 'modify',
